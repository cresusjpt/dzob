                ...
                <ul class="nav navbar-right">
                    ...
                    <li class="dropdown current-user">
                        <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true"
                           href="#">
                            <img src="<?= Url::to('@web/T_assets/images/avatar-1-small.jpg');?>" class="img-circle" alt=""> <span
                                    class="username hidden-xs"><?=$user->PRENOM ?> <?=$user->NOM ?></span> <i class="fa fa-caret-down "></i>
                        </a>
    ...
    <nav id="pageslide-left" class="pageslide inner">
        ...
        <div class="slide-tools">
            ...
            <div class="col-xs-6 text-right no-padding">
                <a class="btn btn-sm log-out text-right" href="<?= Url::toRoute('site/logout')?>" data-method="post" >
            ...
            <div class="hidden-xs" id="style_selector">
                <div id="style_selector_container">
                    ...
                    <div class="images icons-color">
                        <a href="#" id="default"><img src="<?= Url::to('@web/T_assets/images/color-1.png');?>" alt="" class="active"></a>
                        <a href="#" id="style2"><img src="<?= Url::to('@web/T_assets/images/color-2.png');?>" alt=""></a>
                        <a href="#" id="style3"><img src="<?= Url::to('@web/T_assets/images/color-3.png');?>" alt=""></a>
                        <a href="#" id="style4"><img src="<?= Url::to('@web/T_assets/images/color-4.png');?>" alt=""></a>
                        <a href="#" id="style5"><img src="<?= Url::to('@web/T_assets/images/color-5.png');?>" alt=""></a>
                        <a href="#" id="style6"><img src="<?= Url::to('@web/T_assets/images/color-6.png');?>" alt=""></a>
                        <a href="#" id="style7"><img src="<?= Url::to('@web/T_assets/images/color-7.png');?>" alt=""></a>
                        <a href="#" id="style8"><img src="<?= Url::to('@web/T_assets/images/color-8.png');?>" alt=""></a>
                        <a href="#" id="style9"><img src="<?= Url::to('@web/T_assets/images/color-9.png');?>" alt=""></a>
                        <a href="#" id="style10"><img src="<?= Url::to('@web/T_assets/images/color-10.png');?>" alt=""></a>
                    </div>
                    <div class="box-title">
                        Backgrounds for Boxed Version
                    </div>
                    <div class="images boxed-patterns">
                        <a href="#" id="bg_style_1"><img src="<?= Url::to('@web/T_assets/images/bg.png');?>" alt=""></a>
                        <a href="#" id="bg_style_2"><img src="<?= Url::to('@web/T_assets/images/bg_2.png');?>" alt=""></a>
                        <a href="#" id="bg_style_3"><img src="<?= Url::to('@web/T_assets/images/bg_3.png');?>" alt=""></a>
                        <a href="#" id="bg_style_4"><img src="<?= Url::to('@web/T_assets/images/bg_4.png');?>" alt=""></a>
                        <a href="#" id="bg_style_5"><img src="<?= Url::to('@web/T_assets/images/bg_5.png');?>" alt=""></a>
                    </div>
                ...
                <div class="e-slider owl-carousel owl-theme">
                    <div class="item">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="note-content">
                                ...
                                commodi consequat.
                                Quis aute iure reprehenderit in <strong>voluptate velit</strong> esse cillum dolore eu
                                ...
                                quisquam est, qui dolorem ipsum, quia dolor sit, amet, consectetur, adipisci v'elit, sed
                                quia non numquam eius modi tempora incidunt, ut labore et dolore magnam aliquam quaerat
                                voluptatem.
                                <br>
                                Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit
                                laboriosam, nisi ut <strong>aliquid ex ea commodi consequatur?</strong>
                                <br>
                            ...
                            <div class="note-options pull-right">
                                <a href="#readNote" class="read-note"><i class="fa fa-chevron-circle-right"></i>
                                    Read</a><a href="#" class="delete-note"><i class="fa fa-times"></i> Delete</a>
                            </div>
                        </div>
                        <div class="panel-footer">
                            <div class="avatar-note"><img src="<?= Url::to('@web/T_assets/images/avatar-2-small.jpg');?>" alt="">
                            </div>
                    ...
                    <div class="item">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="note-options pull-right">
                                <a href="#" class="read-note"><i class="fa fa-chevron-circle-right"></i> Read</a><a
                                        href="#" class="delete-note"><i class="fa fa-times"></i> Delete</a>
                            </div>
                        </div>
                        <div class="panel-footer">
                            <div class="avatar-note"><img src="<?= Url::to('@web/T_assets/images/avatar-3-small.jpg');?>" alt="">
                            </div>
                    ...
                    <div class="item">
                        ...
                        <div class="panel-footer">
                            <div class="avatar-note"><img src="<?= Url::to('@web/T_assets/images/avatar-4-small.jpg');?>" alt="">
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="fileupload fileupload-new contributor-avatar" data-provides="fileupload">
                                <div class="fileupload-new thumbnail"><img src="<?= Url::to('@web/T_assets/images/anonymous.jpg');?>" alt=""
                                                                           width="50" height="50"/>
                                </div>
