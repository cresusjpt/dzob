    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-white">
            ...
            <div class="panel-body">
                <p>
                    Export HTML Table to JSON, XML, PNG, CSV, TXT, SQL, MS-Word, Ms-Excel, Ms-Powerpoint and PDF. You
                    can easily set the font size, separator, export type, margin and etc..
                </p>
                <div class="row">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover" id="sample-table-2">
                        ...
                        <tr>
                            ...
                            <td>Senor Designer</td>
                            <td>PENIS Designer</td>
                            <td>(111)-114-1173</td>
                            <td>
                                <a href="#" class="edit-row">
                                    Edit
